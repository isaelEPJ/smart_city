...
class ReportDenuncia extends StatelessWidget {
  final Categories category;
  const ReportDenuncia({Key? key, required this.category}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final textDenunciaController = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  maxLines: 10,
                  controller: textDenunciaController,
