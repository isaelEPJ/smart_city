...
class ReportSugestao extends StatelessWidget {
  final Categories category;
  const ReportSugestao({Key? key, required this.category}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final textSugestController = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  maxLines: 10,
                  controller: textSugestController,
